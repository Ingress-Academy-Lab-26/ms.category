...
public class CategoryServiceHandler implements CategoryService {
    ...
    public void createCategory(CategoryRequest categoryRequest) {
        ...
        List<CategoryEntity> baseCategories = CATEGORY_MAPPER.mapBaseCategoryDetailToListCategoryEntity(separationResult.getBaseCategories());
        categoryRepository.saveAll(baseCategories);
        List<CategoryEntity> subCategories = CATEGORY_MAPPER.mapSubCategoryDetailToListCategoryEntity(separationResult.getSubCategories());
